...
export default function SourceExplorerPage() {
  ...
  // In a full implementation, this would open the create job modal with pre-filled source
  // For demo purposes, we navigate to workflows where user can create a new workflow/job
      ...
      <div className="flex items-center justify-center h-screen">
        <Card className="max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <Button onClick={() => router.push('/integrations/sources')}>
              Back to Sources
            </Button>
          </CardContent>
        </Card>
